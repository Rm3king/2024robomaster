...
%腿长150mm
%可变量，腿长决定
ValData = [0.142,0.028,0.466244,0.00775422270076162];
...
%%腿长160mm
ValData = [0.143,0.037,0.466244,0.00868916793973059];
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%170
ValData = [0.144,0.046,0.466244,0.00981950253607773];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%180
ValData = [0.146,0.055,0.466244,0.0135622076044732];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%190
ValData = [0.148,0.062,0.466244,0.0150741475059229];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
%%200
Q = [400 0 0 0 0 0; 0 200 0 0 0 0; 0 0 500 0 0 0; 0 0 0 300 0 0; 0 0 0 0 4800 0; 0 0 0 0 0 10]; 
R = [5 0; 0 3]; %权重矩阵 R 的设计
ValData = [0.151,0.07,0.466244,0.0167744425852543];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%210
ValData = [0.154,0.075,0.466244,0.0181750341952167];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%220
ValData = [0.158,0.083,0.466244,0.0202083649287384];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%230
ValData = [0.161,0.089,0.466244,0.0218543764203801];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
%%240
Q = [500 0 0 0 0 0; 0 200 0 0 0 0; 0 0 500 0 0 0; 0 0 0 300 0 0; 0 0 0 0 5800 0; 0 0 0 0 0 10]; 
ValData = [0.165,0.096,0.466244,0.0242016029932409];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%250
ValData = [0.169,0.101,0.466244,0.0260678246801642];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%260
ValData = [0.173,0.107,0.466244,0.028015362622259];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%270
ValData = [0.178,0.114,0.466244,0.0307208908991397];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
%%280
Q = [800 0 0 0 0 0; 0 200 0 0 0 0; 0 0 500 0 0 0; 0 0 0 300 0 0; 0 0 0 0 5800 0; 0 0 0 0 0 10];
ValData = [0.182,0.119,0.466244,0.0328164454578158];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%290
ValData = [0.186,0.124,0.466244,0.0349544465612563];
%  Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
...
%%300
ValData = [0.192,0.13,0.466244,0.0378466336154669];
...
%%310
ValData = [0.196,0.135,0.466244,0.0400274648536275];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%320
ValData = [0.201,0.14,0.466244,0.042921145709102];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%330
ValData = [0.205,0.144,0.466244,0.0450601709324669];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
%%340
Q = [500 0 0 0 0 0; 0 180 0 0 0 0; 0 0 200 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
ValData = [0.21,0.149,0.466244,0.0478401791323126];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%350
ValData = [0.216,0.155,0.466244,0.0511471712361732];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%360
ValData = [0.221,0.16,0.466244,0.0542027351081552];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%370
ValData = [0.226,0.164,0.466244,0.0569429797131649];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%380
ValData = [0.233,0.168,0.466244,0.0601442713663326];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
...
fprintf('\t/* OffGround -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{0, 0, 0, 0, 0, 0, %8.6f, %8.6f, 0, 0, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(2,1),-K(2,2),-K(2,5),-K(2,6))
%%390
ValData = [0.239,0.171,0.466244,0.0632223305312283];
% Q = [500 0 0 0 0 0; 0 10 0 0 0 0; 0 0 100 0 0 0; 0 0 0 150 0 0; 0 0 0 0 4000 0; 0 0 0 0 0 13]; %权重矩阵 Q 的设计
% R = [12 0; 0 10]; %权重矩阵 R 的设计
K = LQRFun(BasicData,ValData,Q,R);
fprintf('\t/* Normal -K\tL=%8.6f\tR00=%2.2f\tR11=%2.2f */\n \t{%8.5f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f, %8.6f},\n',2*ValData(1),R(1,1),R(2,2),-K(1,1),-K(1,2),-K(1,3),-K(1,4),-K(1,5),-K(1,6),-K(2,1),-K(2,2),-K(2,3),-K(2,4),-K(2,5),-K(2,6))
